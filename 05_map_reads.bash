...
in_filepath=/gpfs01/home/mbzlld/data/stickleback/trimmed_fqs

# set the output filepath where you want to put the bams
out_filepath=/gpfs01/home/mbzlld/data/stickleback
...
R1filename=$""$in_filepath"/"$individual"_R1.fastq.gz"
R2filename=$""$in_filepath"/"$individual"_R2.fastq.gz"
echo ""$R1filename" 
"$R2filename" 
