...
#SBATCH --job-name=Trimmed_backup
...
rclone --transfers 1 --checkers 1 --bwlimit 100M --checksum copy /gpfs01/home/mbzlld/data/stickleback/Trimmed MacCollLab2:HPC_data_backup/bigdata/Trimmed
 

# and check that the two folders are identical
rclone check --one-way /gpfs01/home/mbzlld/data/stickleback/Trimmed MacCollLab2:HPC_data_backup/bigdata/Trimmed
