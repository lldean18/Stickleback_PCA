...
#SBATCH --output=/gpfs01/home/mbzlld/code_and_scripts/slurm_out_scripts/BD_read_depth_clean_bams/slurm-%x-%j.out
...
# set variables
in_filepath=/gpfs01/home/mbzlld/data/stickleback/bams/clean_bams
